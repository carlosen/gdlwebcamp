    ...
    <section class="seccion contenedor">
        ...
        <div class="calendario">
            ...
            <div class="dia">
                ...
                <p class="hora"><i class="fa fa-clock" aria-hidden="true"></i><?php echo $evento['fecha_evento'] ." ". $evento['hora_evento']; ?></p>
                <p>
                    <?php $categoria_evento = $evento['cat_evento'];?>
                    <?php 
                        switch ($categoria_evento){
                            case 'Talleres':
                                echo '<i class="fa fa-code" aria_hidden="true"></i>Taller';
                                break;
                            case 'Conferencias':
                                echo '<i class="fa fa-comment" aria_hidden="true"></i>Conferencias';
                                break;
                            case 'Seminario':
                                echo '<i class="fa fa-university" aria_hidden="true"></i>Seminarios';
                                break;
                            default: 
                                echo "";
                                break;
